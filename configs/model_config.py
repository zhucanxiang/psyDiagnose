...
embedding_model_dict = {
    ...
    "text2vec": "/root/zhucanxiang/model/GanymedeNil-text2vec-large-chinese",
...
llm_model_dict = {
    ...
    # psyDiagnose 用户“帛凡” @BoFan-tunning 基于ChatGLM-6B 训练并提供的权重合并模型和 lora 权重文件 chatglm-fitness-RLHF
    ...
    "chatglm2-6b": {
        ...
        "local_model_path": "/root/zhucanxiang/model/chatglm2-6b",
        "provides": "ChatGLMLLMChain"
    },
    "chatglm2-6b-32k": {
...
根据上述已知信息，请用专业的精神病学、心理学知识回答用户的问题。请给出最有可能的3个疾病及其概率，以及每个疾病对应的诊断依据。如果无法从中得到答案，请说 “根据已知信息无法回答该问题” 或 “没有提供足够的相关信息”，不允许在答案中添加编造成分，答案请使用中文。 问题是：{question}"""
